 ...
 */
package autocomparealgorithm;

import static autocomparealgorithm.SensorUtility.*;
 ...
 * @author sev_user
 */
public class AutoCompareAlgorithm {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 6; i <= 7; i++) {
            try {
                ...
                Logger.getLogger(AutoCompareAlgorithm.class.getName()).log(Level.SEVERE, null, ex);
            }
            try {
                writeResultFile(mPath+"CompareResult.txt", i, timeRuning, timeLifeOn); //Url luu file input duoc sinh ra
                resetData();
            } catch (IOException ex) {
                Logger.getLogger(AutoCompareAlgorithm.class.getName()).log(Level.SEVERE, null, ex);
            }
